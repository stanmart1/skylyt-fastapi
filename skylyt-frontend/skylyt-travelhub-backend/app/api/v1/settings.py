...
def get_settings(db: Session = Depends(get_db)):
    ...
    response_data = {
        ...
        "general_rate_limit_enabled": settings.general_rate_limit_enabled,
        "general_rate_limit_requests": settings.general_rate_limit_requests or '100',
        "general_rate_limit_window": settings.general_rate_limit_window or '60',
        "auth_rate_limit_enabled": settings.auth_rate_limit_enabled,
        "auth_rate_limit_requests": settings.auth_rate_limit_requests or '5',
        "auth_rate_limit_window": settings.auth_rate_limit_window or '60',
        "booking_rate_limit_enabled": settings.booking_rate_limit_enabled,
        "booking_rate_limit_requests": settings.booking_rate_limit_requests or '20',
        "booking_rate_limit_window": settings.booking_rate_limit_window or '60',
        "admin_rate_limit_enabled": settings.admin_rate_limit_enabled,
        "admin_rate_limit_requests": settings.admin_rate_limit_requests or '30',
        "admin_rate_limit_window": settings.admin_rate_limit_window or '600',

...
class EmailService:
    ...
    async def _send_templated_email(self, to_email: str, template_name: str, context: Dict[str, Any], subject: str) -> bool:
    ...
    def send_welcome_email(self, to_email: str, user_name: str) -> bool:
        ...
        import asyncio
        return asyncio.run(self._send_templated_email(
            to_email,
            "welcome",

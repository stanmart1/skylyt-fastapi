...
export const HotelDashboard = ({ onBack }: HotelDashboardProps) => {
    ...
    <div className="space-y-6">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
        ...
        <TabsContent value="analytics" className="space-y-6">
          <Card>
            <CardHeader>
              <CardTitle>Hotel Property Analytics</CardTitle>
            </CardHeader>
            <CardContent>
              <AnalyticsDashboard />
            </CardContent>
        ...
        <TabsContent value="payments" className="space-y-6">
          <Card>
            <CardHeader>
              <CardTitle>Hotel Booking Payments</CardTitle>
            </CardHeader>
            <CardContent>
              <PaymentManagement />
            </CardContent>
        ...
        <TabsContent value="reviews" className="space-y-6">
          <Card>
            <CardHeader>
              <CardTitle>Hotel Reviews & Feedback</CardTitle>
            </CardHeader>
            <CardContent>
              <ReviewManagement />
            </CardContent>

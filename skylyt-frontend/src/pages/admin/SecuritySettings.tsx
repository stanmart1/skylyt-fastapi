  ...
  const fetchSettings = async () => {
    try {
      ...
      setSecurityForm({
        ...
        general_rate_limit_enabled: data.general_rate_limit_enabled,
        ...
        auth_rate_limit_enabled: data.auth_rate_limit_enabled,
        auth_rate_limit_requests: data.auth_rate_limit_requests || '5',
        auth_rate_limit_window: data.auth_rate_limit_window || '60',
        booking_rate_limit_enabled: data.booking_rate_limit_enabled,
        ...
        admin_rate_limit_enabled: data.admin_rate_limit_enabled,
